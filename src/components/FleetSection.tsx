...
export default function FleetSection({ onBookCar }: FleetSectionProps) {
  ...
  return (
    <section id="fleet" className="py-20 bg-gradient-to-b from-blue-50/80 via-white to-slate-50 text-slate-900 relative border-b border-slate-200 poppins">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3-Car Showcase Carousel Row matching screenshot */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-12">
          
          {/* Left Car */}
          <div className="flex items-center space-x-3 text-center">
            <div className="opacity-60 scale-90 transition-all">
              <div className="text-sm font-bold text-slate-800 mb-1">Clio</div>
              <div className="text-[11px] text-slate-500 font-semibold mb-2">5+1 Seats</div>
          ...
          <div className="text-center space-y-2 bg-white/80 backdrop-blur-md p-6 rounded-3xl border border-blue-200 shadow-xl max-w-md w-full">
            <div className="text-xl font-black text-slate-900">Toyota Innova</div>
            <div className="text-xs text-blue-600 font-extrabold">6+1 Seats</div>
        ...
        {/* Detailed Innova Feature Box Box matching screenshot */}
        <div className="max-w-5xl mx-auto bg-white border border-slate-200 rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8 p-6 sm:p-8 space-y-6">
            ...
            <div className="flex flex-wrap justify-between items-start gap-2">
              <div>
                <h3 className="text-2xl font-black text-slate-900">Toyota Innova Crysta</h3>
              ...
              <div className="bg-amber-50 border border-amber-200 px-3 py-1 rounded-full text-xs font-bold text-amber-700 flex items-center space-x-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-200 text-center">
              <div>
                <div className="text-[10px] text-slate-500 font-bold uppercase">Outstation Rate</div>
                <div className="text-lg font-black text-blue-700">₹18<span className="text-xs text-slate-500 font-normal">/km</span></div>
              </div>
              <div>
                <div className="text-[10px] text-slate-500 font-bold uppercase">Local 8h/80km</div>
                <div className="text-lg font-black text-slate-900">₹3,800</div>
              </div>
              <div>
                <div className="text-[10px] text-slate-500 font-bold uppercase">Min. Outstation</div>
                <div className="text-lg font-black text-slate-900">300 km<span className="text-xs text-slate-500 font-normal">/day</span></div>
              </div>
              <div>
                <div className="text-[10px] text-slate-500 font-bold uppercase">Driver Batta</div>
                <div className="text-lg font-black text-emerald-600">Included</div>
              </div>
            </div>

            {/* Red Note Box */}
            <div className="bg-red-50 border border-red-200 p-3 rounded-xl text-xs text-red-700 flex items-center space-x-2 font-medium">
          ...
          <div className="lg:col-span-4 bg-blue-600 text-white p-6 sm:p-8 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="text-[10px] uppercase font-bold text-blue-200">DRIVER ALLOWANCE</div>
                <div className="text-xl font-black text-amber-300">Rs. 500 <span className="text-xs font-semibold text-blue-100">Per Day (Driver Batta)</span></div>
              </div>

              <div className="pt-2 border-t border-blue-500">
                <div className="text-[10px] uppercase font-bold text-blue-200">RENT / DAY</div>
                <div className="text-3xl font-black text-white">Rs. 2200</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3.5 px-4 rounded-xl bg-slate-950 hover:bg-slate-900 text-white font-extrabold text-xs uppercase tracking-wider flex items-center justify-center space-x-2 shadow-lg transition-all hover:scale-105"
              >
                <span>Book This Vehicle</span>
                <ArrowRight className="w-4 h-4 text-amber-400" />
              </button>

              <div className="text-[10px] text-center text-blue-100 font-semibold flex items-center justify-center space-x-1">
