...
export default function TopBar() {
  return (
    <div className="bg-[#0b192e] text-slate-300 text-xs py-2 px-4 border-b border-slate-800 hidden md:block poppins">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        
        {/* Contact Info */}
        <div className="flex items-center space-x-6">
          <a href="mailto:rudhrancabmadurai@gmail.com" className="flex items-center space-x-2 hover:text-amber-400 transition-colors">
            <Mail className="w-3.5 h-3.5 text-blue-400" />
            <span>rudhrancabmadurai@gmail.com</span>
          </a>
