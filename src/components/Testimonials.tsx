        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-8 overflow-hidden">
            <div
              ...
              style={{ transform: `translateX(-${currentIndex * (340 + 24)}px)` }}
            ...
            >
              {extendedList.map((item, idx) => {
                ...
                return (
                  <div
                    key={`${item.id}-${idx}`}
                    className="w-[300px] sm:w-[340px] flex-shrink-0 bg-[#faf8f4] text-slate-900 rounded-[20px] p-7 sm:p-8 shadow-xl flex flex-col justify-between min-h-[300px] sm:min-h-[320px] border border-amber-100/40 transition-opacity duration-500"
